...
enum
{
	...
	INFWEAPON_OCCULTIST_SHOTGUN,
	INFWEAPON_OCCULTIST_GRENADE,
	INFWEAPON_OCCULTIST_RIFLE,

	INFWEAPON_PHYSICIST_GRENADE,
	INFWEAPON_PHYSICIST_RIFLE,
	INFWEAPON_PHYSICIST_GUN,
	...
	INFWEAPON_JOKER_SHOTGUN,
	INFWEAPON_JOKER_GRENADE, // it's time for the end shows. // ffs: bro you are kinda funny lmao
...
/* INFECTION MODIFICATION START ***************************************/
	...
	virtual void SendBroadcast_Localization(int LineBreak, int To, int Priority, int LifeSpan, const char* pText, ...) = 0;
	virtual void SendBroadcast_Localization_P(int LineBreak, int To, int Priority, int LifeSpan, int Number, const char* pText, ...) = 0;
